...
Add web-optimized JPG or WebP files here using these exact filenames.
When a file is present, it replaces the branded placeholder automatically.
...
Tips:
- Long edge ~1600–2400px is enough for the website
- Keep full-resolution masters separate for Printify
- To add more images, edit `src/data/photos.ts`
